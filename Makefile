...
extract: download
	...
	unzip -of data/20135us0015000.zip
	@echo -e "\033[0;32mExtraction has completed.\033[0m"

transform: extract
	@echo -e "\033[1;34mTransforming data in preparation for load...\033[0m"
	sed -i -- 's/\.//g' data/20135us0015000/e20135us0015000.txt
	sed -i -- 's/\.//g' data/20135us0015000/m20135us0015000.txt
...
load: provision transform
	...
	vagrant ssh -c "psql -U postgres -c \"TRUNCATE e20135us0015000; COPY e20135us0015000 FROM '/vagrant/data/20135us0015000/e20135us0015000.txt' DELIMITER ',' CSV\""
	vagrant ssh -c "psql -U postgres -c \"TRUNCATE m20135us0015000; COPY m20135us0015000 FROM '/vagrant/data/20135us0015000/m20135us0015000.txt' DELIMITER ',' CSV\""
